...
jobs:
  perc-service:
    docker:
      - image: 667005031541.dkr.ecr.us-west-1.amazonaws.com/circleci/cci-ddldump:<insert_latest_version_here>
        aws_auth:
    ...
    steps:
      ...
      - run:
          ...
          command: ( echo "SET FOREIGN_KEY_CHECKS=0; "; cat <path/to/mysql/dumpfile.sql> ) | mysql -h 127.0.0.1 <db_name>
      - run:
